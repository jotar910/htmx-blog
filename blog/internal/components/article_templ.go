...
func articleDetailsContent(article *models.Article) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</h1><div is=\"blog-post\" class=\"prose prose-headings:font-heading prose-headings:font-semibold max-w-none\" data-post=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
